...
object NRAppFn : INodeProcessor<NodeNodesListWithMeta> {
    override fun process(node: NodeNodesListWithMeta, processor: Processor, ctx: ProcessingContext, valMode: Boolean): Node? {
        val info = node.info
        val fn = nodeStatic(
            info,
            nodeDefn(

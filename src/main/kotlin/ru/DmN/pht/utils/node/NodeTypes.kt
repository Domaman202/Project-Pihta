...
enum class NodeTypes : INodeType {
    ...
    CLR_NULL_TYPE("clr-null-type", PARSED),
    CLS_("cls", PROCESSED),
    COMPONENT_TYPE("component-type", PARSED),
    COND("cond", PARSED),
    ...
    NOT_NULL_TYPE("not-null-type", PARSED),
    NS_("ns", PROCESSED),
    NULLABLE_TYPE("nullable-type", PARSED),
    // o
    OBJ_("obj", PROCESSED),
    OR_("or", PROCESSED),
    // p
